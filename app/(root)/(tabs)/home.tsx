            ...
            {!loading ? (
              <>
                <Image
                  ...
                  resizeMode="contain"
                />
                <Text className="text-base">No recent ride found</Text>
              </>
            ) : (
        ...
        ListHeaderComponent={() => (
          <>
            <View className="flex-row items-center justify-between my-5">
              <Text className="text-base font-JakartaBold capitalize">
                Welcome,{" "}
                {user?.firstName ||
              ...
              <Pressable
                ...
                className="justify-center items-center w-8 h-8 rounded-full bg-white"
